...
DefinitionBlock ("SSDT-7.aml", "SSDT", 1, "DELL  ", "SaSsdt ", 0x00003000)
{
     ...
     * disassembly, but only 13 were resolved (3 unresolved). Additional
...
//    External (_SB_.PCI0.PEG0.PEGP.SGPO, MethodObj)    // 2 Arguments
    ...
    OperationRegion (SANV, SystemMemory, 0xBCF79D98, 0x0141)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Device (IGPU)
        {
            ...
            {
                If (LEqual (\_SB.PCI0.IGPU.GINI, Zero))
                {
                    Store (One, \_SB.PCI0.IGPU.CLID)
                    Store (One, \_SB.PCI0.IGPU.GINI)
                }
            }
...
//                    "AAPL00,override-no-connect", Buffer (0x80)
//                    {
//                        0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x4c, 0xa3, 0x41, 0x54,
//                        0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x01, 0x04, 0x90, 0x22, 0x13, 0x78,
//                        0x0a, 0xc8, 0x95, 0x9e, 0x57, 0x54, 0x92, 0x26, 0x0f, 0x50, 0x54, 0x00,
//                        0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
//                        0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0xf5, 0x1d, 0x56, 0xfc, 0x50, 0x00,
//                        0x16, 0x30, 0x30, 0x20, 0x25, 0x00, 0x58, 0xc2, 0x10, 0x00, 0x00, 0x1a,
//                        0xd6, 0x12, 0x56, 0xa0, 0x50, 0x00, 0x16, 0x30, 0x30, 0x20, 0x25, 0x00,
//                        0x58, 0xc2, 0x10, 0x00, 0x00, 0x1a, 0x00, 0x00, 0x00, 0xfe, 0x00, 0x34,
//                        0x59, 0x34, 0x47, 0x4d, 0x80, 0x31, 0x35, 0x36, 0x41, 0x54, 0x0a, 0x20,
//                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x41, 0x01, 0x96, 0x00, 0x00, 0x00,
//                        0x00, 0x01, 0x01, 0x0a, 0x20, 0x20, 0x00, 0xcf
//                    },
                    "AAPL,slot-name", "Built In",
                    "built-in", Buffer(){0x00},
                    "name", Buffer() {"Intel Graphics Controller"},
                    "model", Buffer (0x16) {"Intel HD Graphics 4400"},
                    "device_type", Buffer (0x13) {"Graphics Controller"},
                    "RM,device-id", Buffer (0x04) {0x12,0x04,0x00,0x00},
                    "AAPL,ig-platform-id", Buffer (0x04) {0x06,0x00,0x26,0x0a},
//                    "@0,av-signal-type", Buffer() {0x08,0x00,0x00,0x00},
